...
public class HttpVerticle extends AbstractVerticle {
    ...
    private byte[] hashToCheck(String password,byte[] salt) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    private ArrayList<byte[]> hashToStore(String password) throws NoSuchAlgorithmException, InvalidKeySpecException, UnsupportedEncodingException {
